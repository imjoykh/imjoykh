...
Original file is located at
    https://colab.research.google.com/drive/1cPEYxOk4_I8UAMcFQlYfo1FK0RUMK40N

**Name: Khandoker Akhinur Ibne Jaman**
# Project Title: Handwritten Digit Recognition using Gaussian Naive Bayes, Suppor Vector Machine and Random Forest Classifier and compare the performance of these 3 models
